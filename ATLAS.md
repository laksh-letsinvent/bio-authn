...
**ISO/IEC 2382-37** — the biometrics vocabulary standard. The authority when two teams argue over what "verification" or "identification" means.

**ISO/IEC 30107** — presentation attack detection. Part 1 framework, Part 3 testing. The PAD bible; iBeta tests against Part 3.

**ISO/IEC 24745** — biometric information protection: irreversibility, unlinkability, renewability. The standard a template-protection claim should cite.

**ISO/IEC 19794 / ISO/IEC 39794** — biometric data interchange formats. 19794 is the long-standing family; 39794 is the newer, extensible replacement ICAO is moving to for ePassports.

**iBeta** — the NIST/NVLAP-accredited lab most associated with commercial PAD testing against ISO/IEC 30107-3 (Levels 1 and 2).

**NIST FRTE / FATE** — see §5. Independent accuracy and PAD benchmarking; the neutral public yardstick.

**FIDO Alliance / FIDO2** — the body and standard behind passkeys/WebAuthn. Not a biometric standard, but the credential model selfie-auth sits beside.

---

## 8. Regulation (UK/EU focus)

**GDPR (UK GDPR + DPA 2018)** — biometric data for identification is special category; needs explicit consent or another defined lawful basis, plus a DPIA. Retention, residency, and erasure all become design constraints, not afterthoughts. The "right to erasure" interacts awkwardly with auth templates seeded from an IDV selfie.

**Information Commissioner's Office** *(ICO)* — the UK data-protection regulator. Has issued specific guidance on biometric data and enforced against biometric deployments.

**PSD2 / SCA** — the payments rule mandating strong customer authentication (see §1). Determines whether selfie-auth can stand as a regulated factor.

**Financial Conduct Authority** *(FCA)* — UK financial regulator; the firm's own SCA interpretation is signed off against FCA expectations.

**UK Digital Identity & Attributes Trust Framework** *(DIATF)* — the UK government scheme certifying digital-identity providers. The **Gamma (0.4)** version came into force 1 July 2025; the framework was formalised into the **DVS Trust Framework v1.0** (with the UK trust mark) in March 2026. The certification route for UK reusable digital identity.

**eIDAS 2.0** — EU Regulation 2024/1183, in force since 20 May 2024. Mandates that every member state offer an **EU Digital Identity Wallet** *(EUDI Wallet)* by December 2026, with regulated sectors (banking included) required to accept it by late 2027. Reshapes how identity and biometrics are presented across the EU; UK firms serving EU customers can't ignore it.

**EUDI Wallet** — the member-state-issued wallet under eIDAS 2.0 holding verifiable credentials at Level of Assurance High. Shifts some IDV/auth from bank-built flows to a user-held wallet model.

**Illinois Biometric Information Privacy Act** *(BIPA)* — US (Illinois) law, named here because it set the global tone on biometric consent and statutory damages; a reference point even outside the US.
